            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-start gap-8 mt-5">
                    ...
                    <div class="w-full md:w-64 shrink-0">
                        <div
                            class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden md:sticky md:top-26 min-h-150 flex flex-col"
                        >
                            <!-- 用户简要信息 -->
                            <div class="p-6 border-b border-gray-50 flex flex-col items-center">
                                <el-avatar
                                    :size="80"
                                    :src="
                                        getImageURL(userStore.avatarUrl) ||
                            ...
                            <nav class="p-4 space-y-2 flex-1 flex flex-col">
                                ...
                                >
                                    ...
                                    <el-icon v-if="activeTab === item.key" class="ml-auto text-sm"
                                        ><ArrowRight
                                    /></el-icon>
                                </div>
                    ...
                    <div class="flex-1 min-w-0">
                        <transition name="fade-transform" mode="out-in">
                            <div
                                :key="activeTab"
                                class="bg-white rounded-2xl shadow-sm border border-gray-100 min-h-150 overflow-hidden"
                            >
...
<script setup lang="ts">
    ...
    import AddressManager from './model/AddressManager/index.vue'
    import OrderManager from './model/OrderManager/index.vue'
    ...
    const menuItems = [
        ...
        },
        {
            ...
            component: markRaw(AddressManager),
        },
        {
            key: 'orders',
            label: '我的订单',
            icon: markRaw(Tickets),
            component: markRaw(OrderManager),
        },
        {
            key: 'favorites',
            label: '我的收藏',
            icon: markRaw(Star),
            component: markRaw(FavoriteManager),
        },
    ...
    watch(
        ...
        (newTab) => {
            if (
                ...
                menuItems.some((item) => item.key === newTab)
            ) {
    ...
    const currentComponent = computed(() => {
        ...
        return {
            render: () =>
                h('div', { class: 'p-20 text-center text-gray-400' }, [
